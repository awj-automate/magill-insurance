...
export const applications: Application[] = [
  {
    ...
    flagCount: 3,
    summary:
      "9-horse mortality + major medical renewal. AI surfaced 2 horses with disclosed conditions needing underwriter review and 1 valuation jump >25% YoY.",
    conditions: [
...
— Mike`,
    ...
    audit: [
      { ts: "2026-05-06 14:22:08", actor: "Make.com", event: "Webhook received · Formstack #FS-44102 · payload validated", level: "info" },
      ...
      { ts: "2026-05-06 14:22:15", actor: "Claude · Sonnet 4.6", event: "Condition summary generated · confidence 0.62 (below 0.75 threshold) → routed to human review", level: "warn" },
...
— Mike`,
    ...
    audit: [
      { ts: "2026-05-06 11:08:02", actor: "Make.com", event: "Webhook received · Formstack #FS-44099", level: "info" },
      { ts: "2026-05-06 11:08:03", actor: "Rules engine", event: "Classified: New Business · single entity", level: "info" },
      { ts: "2026-05-06 11:08:06", actor: "Claude · Sonnet 4.6", event: "Condition summary · confidence 0.91 · auto-approved", level: "ok" },
      { ts: "2026-05-06 11:08:06", actor: "Claude · Haiku 4.5", event: "Email + SMS draft generated from template NB-01", level: "info" },
  ...
  },
  {
    ...
    audit: [
      { ts: "2026-05-05 16:41:11", actor: "Make.com", event: "Webhook received · Formstack #FS-44081", level: "info" },
      { ts: "2026-05-05 16:41:12", actor: "Rules engine", event: "Classified: Change Form · endorsement type 'medical-add'", level: "info" },
      { ts: "2026-05-05 16:41:14", actor: "Claude · Sonnet 4.6", event: "Drafts generated · confidence 0.88 · auto-approve eligible", level: "ok" },
      { ts: "2026-05-05 16:48:09", actor: "CSR (Lauren)", event: "Drafts approved · sent via Resend + Twilio", level: "ok" },
    ],
  },
  {
    id: "M-2026-0478",
    ...
    flagCount: 1,
    summary:
      "4-horse new business app. AI surfaced one horse (Cinder) with a prior insurer non-renewal that wasn't disclosed in the 'prior coverage' section.",
    ...
    audit: [
      { ts: "2026-05-05 09:14:03", actor: "Make.com", event: "Webhook received · Formstack #FS-44065", level: "info" },
      ...
      { ts: "2026-05-05 09:14:08", actor: "Claude · Sonnet 4.6", event: "Clarification email drafted · confidence 0.78", level: "info" },
    ],
  },
  {
    id: "M-2026-0477",
    ...
    audit: [
      { ts: "2026-05-04 17:55:21", actor: "Make.com", event: "Webhook received · Formstack #FS-44052", level: "info" },
      ...
      { ts: "2026-05-04 17:55:28", actor: "Claude · Sonnet 4.6", event: "Renewal diff narrative · confidence 0.71", level: "info" },
    ],
  },
  {
    id: "M-2026-0476",
    ...
    drafts: { email: "", sms: "" },
    audit: [
      { ts: "2026-05-04 12:30:05", actor: "Make.com", event: "Webhook received · Formstack #FS-44041", level: "info" },
